  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="userlist" border stripe>
        ...
        <el-table-column label="宿舍" prop="dorAddress"></el-table-column>
        <el-table-column label="处理状态" prop="absenceProcessStatus"></el-table-column>
        <el-table-column label="处理人" prop="processPerson"></el-table-column>
...
export default {
  ...
  methods: {
    async getUserList() {
      const { data: res } = await this.$http.get('/smartdor/exception/list', {
