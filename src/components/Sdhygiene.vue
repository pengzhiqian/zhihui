  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="userlist" border stripe>
        ...
        <el-table-column label="卫生检查日期" prop="checkDate"></el-table-column>
        ...
        <el-table-column label="卫生扣分项" prop="deductOptions"></el-table-column>
        <el-table-column label="总扣分" prop="totalPdeduct"></el-table-column>
...
export default {
  ...
  methods: {
    async getUserList() {
      const { data: res } = await this.$http.get('/smartdor/sdhygiene/list', {
