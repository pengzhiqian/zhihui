  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="userlist" border stripe>
        ...
        <el-table-column label="设备IP地址" prop="deviceIpAddress"></el-table-column>
        <el-table-column label="设备出入类型" prop="deviceAccessType"></el-table-column>
        <el-table-column label="设备号" prop="className"></el-table-column>
        <el-table-column label="设备名称" prop="deviceNo"></el-table-column>
...
export default {
  ...
  methods: {
    async getUserList() {
      const { data: res } = await this.$http.get('/smartdor/sddevice/list', {
