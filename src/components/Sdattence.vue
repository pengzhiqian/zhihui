  ...
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="30">
        ...
        <el-col :span="5">
          <el-input
            ...
            v-model="queryInfo.classTeacherName"
            clearable
            @clear="getUserList"
          >
            <el-button slot="append" icon="el-icon-search" @click="getUserList"></el-button>
      ...
      <el-table :data="userlist" border stripe>
        ...
        <el-table-column label="设备出入类型" prop="deviceNo"></el-table-column>
        <el-table-column label="学号" prop="studentNo"></el-table-column>
        <el-table-column label="班级" prop="className"></el-table-column>
        <el-table-column label="学生姓名" prop="studentName"></el-table-column>
        <el-table-column label="宿舍信息" prop="dorAddress"></el-table-column>
        <el-table-column label="考勤时间" prop="accessDate"></el-table-column>
        <el-table-column label="考勤状态" prop="attenceStatus"></el-table-column>
...
export default {
  ...
  methods: {
    async getUserList() {
      const { data: res } = await this.$http.get('/smartdor/sdAttence/list', {
